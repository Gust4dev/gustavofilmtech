...
export const Slide25_SectionMaterial: React.FC = () => {
  return (
    <SlideWrapper className="bg-white" showFlare>
      <div className="absolute top-[-8vmin] right-[-6vmin] w-[48vmin] h-[48vmin] rounded-full bg-brand-red/5 blur-3xl pointer-events-none" />
