...
export const Slide28_SectionPrecificacao: React.FC = () => {
  return (
    <SlideWrapper className="bg-white" showFlare>
      <div className="absolute bottom-[-6vmin] left-[-4vmin] w-[52vmin] h-[52vmin] rounded-full bg-brand-red/5 blur-3xl pointer-events-none" />
