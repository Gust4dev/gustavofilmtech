...
export const Slide13_SectionMarcas: React.FC = () => {
  return (
    <SlideWrapper className="bg-white" showFlare>
      <div className="absolute bottom-[-6vmin] right-[-6vmin] w-[48vmin] h-[48vmin] rounded-full bg-brand-red/5 blur-3xl pointer-events-none" />
