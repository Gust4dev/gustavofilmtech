...
export const Slide12_Final: React.FC = () => {
  ...
  return (
    ...
    <SlideWrapper className="bg-white text-black overflow-hidden flex items-center justify-center" showFlare showLogo>
      ...
      >
        ...
        <motion.h2 
          ...
          className="text-6xl md:text-8xl font-black text-gray-900 uppercase tracking-tighter mb-6 leading-none"
        >
          Vamos <br/>
